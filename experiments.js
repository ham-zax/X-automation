...
export const EXPERIMENT_DIMENSIONS = Object.freeze({
  ...
  network: Object.freeze([
    ...
    'reply_primary_purpose',
    'reply_social_mode',
    'reply_affect_strategy',
    'reply_information_depth',
    'reply_conversation_stage',
    'reply_persona_model_version',
  ]),
});
...
const POPULATION_ALIASES = Object.freeze({
  ...
  primaryPurpose: ['primaryPurpose', 'primary_purpose', 'behavior.primaryPurpose', 'behavior.primary_purpose'],
  socialMode: ['socialMode', 'social_mode', 'behavior.socialMode', 'behavior.social_mode'],
  affectStrategy: ['affectStrategy', 'affect_strategy', 'behavior.affectStrategy', 'behavior.affect_strategy'],
  informationDepth: ['informationDepth', 'information_depth', 'behavior.informationDepth', 'behavior.information_depth'],
  conversationStage: ['conversationStage', 'conversation_stage', 'behavior.conversationStage', 'behavior.conversation_stage'],
  personaModelVersion: ['personaModelVersion', 'persona_model_version', 'behavior.personaModelVersion', 'behavior.persona_model_version'],
  replyPrimaryPurpose: ['replyPrimaryPurpose', 'reply_primary_purpose', 'primaryPurpose', 'primary_purpose', 'behavior.primaryPurpose'],
  replySocialMode: ['replySocialMode', 'reply_social_mode', 'socialMode', 'social_mode', 'behavior.socialMode'],
  replyAffectStrategy: ['replyAffectStrategy', 'reply_affect_strategy', 'affectStrategy', 'affect_strategy', 'behavior.affectStrategy'],
  replyInformationDepth: ['replyInformationDepth', 'reply_information_depth', 'informationDepth', 'information_depth', 'behavior.informationDepth'],
  replyConversationStage: ['replyConversationStage', 'reply_conversation_stage', 'conversationStage', 'conversation_stage', 'behavior.conversationStage'],
  replyPersonaModelVersion: ['replyPersonaModelVersion', 'reply_persona_model_version', 'personaModelVersion', 'persona_model_version', 'behavior.personaModelVersion'],
