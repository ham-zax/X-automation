const SETTINGS_ITEMS = [
  ...
  ['#/settings/first-1000-mission', 'First-1,000 mission', 'Inspect, configure, start, resume, pause, or stop delegated main-feed approval authority.'],
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 max-w-3xl text-sm text-slate-600">Configure growth focus, mission authority, AI, and autonomous replies, or inspect advanced diagnostic detail. Daily work remains in the primary navigation.</p>
      </div>
